...
export async function withdraw(req, res) {
  ...
  try {
    ...
    if (!coins.data.length) {
      return res.status(500).json({ message: "MBLUB non disponibili nel backend" });
    }
